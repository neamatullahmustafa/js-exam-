  ...
  contactInput[0].change(function (e) {
    e.preventDefault();
    chickError(regexName,`Please enter a name between 3 and 9 characters`,e.target);
  });
  ...
  contactInput[4].change(function (e) {
    e.preventDefault();
    chickError(regexPass,`Please enter a pass between 8 and 9 characters`,e.target);
    regexRePass =e.value;
});
  contactInput[4].change(function (e) {
    e.preventDefault();
if (e.value !=regexPhone) {
